...
import { Check, CheckCircle2, ChevronDown, ChevronUp, Play, RefreshCw, ShieldCheck } from 'lucide-react';

const instruments = ['Volatility 10 Index', 'Volatility 25 Index', 'Volatility 50 Index', 'Volatility 75 Index', 'Volatility 100 Index'];
type BulkTrade = { instrument: string; direction: string; stake: number; duration: number; result: string; profit: number; created_at: string };
